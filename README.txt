...
can easily be defined and added.
...
3. Unpack the tarball in a temporary directory (**not** directly in
   ...
   ``install.py``.  On Unix, GNU/Linux, or Mac OS X, type::
...
4. Use a front-end application from the "bin" subdirectory.  For
   example::
...
applications in the ``bin`` directory can be used to solve puzzles::
    ...
    cd <archive_directory_path>/bin
    ./pentominoes3x20.py

On Windows systems, type::

    cd <archive_directory_path>\bin
    python pentominoes3x20.py
